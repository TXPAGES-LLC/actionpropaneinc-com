...
export const metadata: Metadata = {
  title: 'Propane Services in Round Rock, TX | Action Propane Inc',
  description:
    'Action Propane, Inc. delivers residential and commercial propane to Round Rock, TX. Tank installation and system service available. Call 512-259-1196.',
  alternates: { canonical: '/delivery-areas/round-rock' },
  robots: { index: false, follow: true },
  keywords: ['propane delivery Round Rock TX', 'commercial propane Round Rock', 'propane service Round Rock TX'],
  openGraph: {
    title: 'Propane Services in Round Rock, TX | Action Propane Inc',
    description: 'Residential and commercial propane delivery to Round Rock, TX. Tank installation and system service also available from Action Propane. Call 512-259-1196.',
    url: '/delivery-areas/round-rock',
    type: 'website',
  },
}
...
const services = [
  {
    ...
    description:
      'Round Rock homeowners who use propane for heating, cooking, fireplaces, or backup generators can count on consistent delivery from Action Propane. We set up flexible delivery schedules — including automatic fill — so your tank is never empty when you need it.',
  },
  {
    ...
    description:
      'Round Rock is home to a wide range of businesses that use propane in their daily operations. We set up commercial delivery accounts for restaurants, warehouses, construction projects, and other commercial customers with schedules tailored to actual usage.',
  },
  {
    ...
    description:
      'Need a new propane tank at a Round Rock property? We handle everything — sizing, permits, placement, and connection. Both above-ground and underground options are available, and we coordinate with builders on new construction projects.',
  },
  {
    id: 'system-service',
    ...
    description:
      'Our technicians service propane systems at Round Rock homes and businesses. Whether you need a regulator replaced, a line checked, or a new appliance connected, we can schedule a service call and get the work done correctly.',
  },
]

const faqs = [
  {
    q: 'Does Action Propane deliver to Round Rock, TX?',
    a: 'Yes. Round Rock is within our delivery area. We serve residential and commercial customers throughout the city. Call 512-259-1196 to confirm availability and set up service.',
  },
  {
    q: 'How far is your Leander store from Round Rock?',
    a: 'Our store at 2601 S Hwy 183 in Leander is approximately 15–20 minutes from central Round Rock, depending on traffic. We make regular delivery runs throughout the area.',
  },
  {
    q: 'Do you offer commercial propane accounts in Round Rock?',
    a: 'Yes. We work with restaurants, warehouses, construction companies, and other commercial customers in Round Rock. Call us to discuss your volume, usage patterns, and a delivery schedule that works for your business.',
  },
  {
    q: 'Can I get an automatic delivery schedule for my Round Rock home?',
    a: 'Yes. With automatic delivery, we track your estimated usage and schedule a refill before you run low. It is the easiest way to manage propane for homes that depend on it year-round.',
  },
  {
    q: 'How do I switch propane providers to Action Propane in Round Rock?',
    a: 'Call us at 512-259-1196 and we will walk you through the switch. If you own your tank, it is straightforward. If your current provider owns the tank, we can discuss options and help you transition.',
  },
  {
    q: 'What should I do if I smell gas at my Round Rock home or business?',
    a: 'Leave the building immediately, do not use any switches or ignition sources, and call 911. Once it is safe, contact us and we will schedule a technician to inspect your system before restoring service.',
  },
]
...
const CITY_MAP_EMBED = 'https://maps.google.com/maps?q=Round+Rock,TX&output=embed&z=13'

export default function RoundRockAreasWeServePage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
      <PageHero eyebrow="Areas We Serve" title={`Services in ${CITY_STATE}`} description={`Action Propane, Inc. delivers propane and provides full-service propane solutions to Round Rock, TX. We serve residential and commercial customers throughout Round Rock and surrounding Williamson County.`} ctaLabel="Request Service" ctaHref="/contact" breadcrumbs={[{ label: 'Areas We Serve', href: '/areas-we-serve' }, { label: CITY_STATE, href: '/areas-we-serve/round-rock' }]} />

      <section className="bg-white border-b border-[#e2e8f0]" aria-labelledby="round-rock-intro">
        <div className="max-w-5xl mx-auto px-4 py-12 grid lg:grid-cols-2 gap-10 items-start">
          <div>
            <h2 id="round-rock-intro" className="text-2xl font-bold text-[#1e293b] mb-4">Propane Delivery and Service for {CITY_STATE}</h2>
            <p className="text-[#334155] leading-relaxed mb-4">Round Rock has grown into a major city in its own right, but many properties throughout the area still rely on propane — whether for homes outside the core urban grid, commercial operations, or backup energy systems.</p>
            <p className="text-[#334155] leading-relaxed mb-4">Action Propane, Inc. has been delivering to Williamson County for over 30 years. We handle residential and commercial accounts with the same level of service — direct communication, reliable schedules, and competitive pricing without hidden fees.</p>
            <p className="text-[#334155] leading-relaxed mb-6">From your first delivery to ongoing service and system maintenance, we take care of it from one location so you do not have to manage multiple vendors.</p>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-xl overflow-hidden border border-[#e2e8f0] shadow-sm"><iframe src={CITY_MAP_EMBED} width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Round Rock, TX city map" /></div>
      ...
      <section className="bg-[#0f172a] text-white py-10" aria-label="Contact prompt">
        <div className="max-w-4xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div><p className="text-lg font-bold mb-1">Ready to get started in {CITY_STATE}?</p><p className="text-white/60 text-sm">Call us to confirm service availability and get your account set up.</p></div>
      ...
      <section className="bg-white border-t border-[#e2e8f0] py-10" aria-labelledby="nearby-heading">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-2">
            {[{ label: 'Leander, TX', href: '/areas-we-serve/leander' }, { label: 'Cedar Park, TX', href: '/areas-we-serve/cedar-park' }, { label: 'Georgetown, TX', href: '/areas-we-serve/georgetown' }, { label: 'Pflugerville, TX', href: '/areas-we-serve/pflugerville' }, { label: 'Hutto, TX', href: '/areas-we-serve/hutto' }, { label: 'Taylor, TX', href: '/areas-we-serve/taylor' }].map((city) => (
      ...
      <CTABanner heading={`Propane Delivery to ${CITY_STATE}`} subtext="Action Propane, Inc. has served Central Texas for over 30 years. Call to set up residential or commercial service in Round Rock today." />
    </>
  )
}
