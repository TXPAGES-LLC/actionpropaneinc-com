...
export const metadata: Metadata = {
  title: 'Propane Delivery in Hutto, TX | Action Propane Inc',
  description:
    'Action Propane, Inc. delivers residential and commercial propane to Hutto, TX. Tank installation and system service available. Call 512-259-1196.',
  alternates: { canonical: '/delivery-areas/hutto' },
  robots: { index: false, follow: true },
  keywords: ['propane delivery Hutto TX', 'propane service Hutto Texas', 'residential propane Hutto TX'],
  openGraph: {
    title: 'Propane Delivery in Hutto, TX | Action Propane Inc',
    description: 'Action Propane, Inc. delivers propane to Hutto, TX residents and businesses. Flexible delivery schedules for new and existing customers. Call 512-259-1196.',
    url: '/delivery-areas/hutto',
    type: 'website',
  },
}
...
const services = [
  {
    ...
    description:
      'Hutto has been one of the fastest-growing cities in Williamson County, with new subdivisions expanding in all directions. Many of these homes rely on propane where natural gas has not yet been installed. Action Propane delivers to Hutto residences and sets up flexible delivery schedules for both existing and new customers.',
  },
  {
    ...
    description:
      'Hutto businesses that use propane for food service, space heating, or industrial purposes can set up commercial delivery accounts with Action Propane. We schedule deliveries based on your usage patterns and keep you supplied without interruption.',
  },
  {
    ...
    description:
      'New construction is ongoing in Hutto, and many builds need propane tank installation before move-in. We handle complete above-ground and underground installations, including sizing, permitting coordination, and final connection.',
  },
  {
    id: 'system-service',
    ...
    description:
      'If your propane system at a Hutto property needs attention — a regulator check, a line inspection, or an appliance hookup — our technicians can schedule a visit and take care of it properly.',
  },
]

const faqs = [
  {
    q: 'Does Action Propane deliver to Hutto, TX?',
    a: 'Yes. Hutto is within our delivery area. We serve residential and commercial customers throughout the city. Call 512-259-1196 to confirm your address and set up service.',
  },
  {
    q: 'How do I get started with propane delivery in Hutto?',
    a: 'Call us at 512-259-1196. We will confirm your address, review your tank situation, and schedule an initial delivery. New tank installation can also be arranged if needed.',
  },
  {
    q: 'Do you install propane tanks for new homes in Hutto?',
    a: 'Yes. We install propane tanks for new builds in Hutto regularly. Contact us early in your build process to coordinate timing with your contractor.',
  },
  {
    q: 'Is automatic propane delivery available in Hutto?',
    a: 'Yes. Automatic delivery is available for Hutto customers. We estimate your usage and schedule fills before your tank runs low, so you do not have to monitor the gauge yourself.',
  },
  {
    q: 'What areas of Hutto do you serve?',
    a: 'We serve all parts of Hutto, including established neighborhoods and newer developments. If you are not sure about your specific address, call us and we can confirm.',
  },
  {
    q: 'How far is your store from Hutto?',
    a: 'Our store at 2601 S Hwy 183 in Leander is approximately 30–40 minutes from Hutto via TX-130. We make regular delivery runs through Williamson County.',
  },
]
...
const CITY_MAP_EMBED = 'https://maps.google.com/maps?q=Hutto,TX&output=embed&z=13'

export default function HuttoAreasWeServePage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
      <PageHero eyebrow="Areas We Serve" title={`Services in ${CITY_STATE}`} description={`Action Propane, Inc. delivers propane to Hutto, TX and the surrounding Williamson County area. As Hutto continues to grow, we provide residential and commercial propane service to keep up with the community's needs.`} ctaLabel="Request Service" ctaHref="/contact" breadcrumbs={[{ label: 'Areas We Serve', href: '/areas-we-serve' }, { label: CITY_STATE, href: '/areas-we-serve/hutto' }]} />

      <section className="bg-white border-b border-[#e2e8f0]" aria-labelledby="hutto-intro">
        <div className="max-w-5xl mx-auto px-4 py-12 grid lg:grid-cols-2 gap-10 items-start">
          <div>
            <h2 id="hutto-intro" className="text-2xl font-bold text-[#1e293b] mb-4">Propane Delivery for {CITY_STATE}</h2>
            <p className="text-[#334155] leading-relaxed mb-4">Hutto&apos;s growth has been remarkable, and with that growth comes an increased need for propane services in areas where natural gas infrastructure has not yet arrived. Action Propane delivers to Hutto and nearby communities as part of our regular Williamson County delivery routes.</p>
            <p className="text-[#334155] leading-relaxed mb-4">We have served Central Texas for over 30 years, and we understand the logistics of both suburban and rural delivery in the region. Our goal is straightforward service — show up when scheduled, deliver the right amount, and make it easy to get in touch when you need us.</p>
            <p className="text-[#334155] leading-relaxed mb-6">Call us to confirm service for your Hutto address and get set up quickly.</p>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-xl overflow-hidden border border-[#e2e8f0] shadow-sm"><iframe src={CITY_MAP_EMBED} width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Hutto, TX city map" /></div>
      ...
      <section className="bg-[#0f172a] text-white py-10" aria-label="Contact prompt">
        <div className="max-w-4xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div><p className="text-lg font-bold mb-1">Ready to get started in {CITY_STATE}?</p><p className="text-white/60 text-sm">Call to confirm availability and set up delivery service for your Hutto address.</p></div>
      ...
      <section className="bg-white border-t border-[#e2e8f0] py-10" aria-labelledby="nearby-heading">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-2">
            {[{ label: 'Round Rock, TX', href: '/areas-we-serve/round-rock' }, { label: 'Pflugerville, TX', href: '/areas-we-serve/pflugerville' }, { label: 'Taylor, TX', href: '/areas-we-serve/taylor' }, { label: 'Georgetown, TX', href: '/areas-we-serve/georgetown' }, { label: 'Leander, TX', href: '/areas-we-serve/leander' }].map((city) => (
      ...
      <CTABanner heading={`Propane Delivery to ${CITY_STATE}`} subtext="Action Propane, Inc. delivers to Hutto and throughout Williamson County. Call to confirm service availability for your address." />
    </>
  )
}
